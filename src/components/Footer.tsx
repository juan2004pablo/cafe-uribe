        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-6">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm text-background/70">100% Colombiano</span>
              </div>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link to="/" className="text-background/80 hover:text-primary transition-colors">Inicio</Link></li>
              <li><Link to="/nosotros" className="text-background/80 hover:text-primary transition-colors">Nosotros</Link></li>
              <li><Link to="/variedades" className="text-background/80 hover:text-primary transition-colors">Variedades</Link></li>
              <li><Link to="/clientes-b2b" className="text-background/80 hover:text-primary transition-colors">Clientes B2B</Link></li>
